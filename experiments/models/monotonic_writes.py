...
# W1 is acked on mongo1 in the brief window before it steps down; mongo3 is then
# elected on the majority side. We wait for that election as an EVENT (barrier),
# not by sleeping a guessed number of seconds.
FAILOVER_WAIT = 40
HEAL_WAIT = 12
